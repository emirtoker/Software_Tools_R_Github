...
![](gnu_logo.png){ width=23% } ![](Richard.jpg){ width=15% }
...
![](kernel_00.jpg){ width=20% } ![](kernerl_01.png){ width=30% }  ![](kernerl_02.png){ width=30% }
...
![](term_01.jpg) ![](term_00.png){ width=45% }
...
- Connect to remote computer or machine (supercomputer or
...
- 2) Quiz type (four different options)
