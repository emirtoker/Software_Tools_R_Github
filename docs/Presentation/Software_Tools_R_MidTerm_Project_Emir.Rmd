...
11. Print minimum and maximum values for "avg_month" and find which year and which month they were observed
12. Calculate the mean temperature for each years (*you will probably need the* ***na.rm*** *(NA Remove)* *option* ) "avg_year"
13. Calculate the mean temperature of all data and assign it as "avg_temp" and print it
